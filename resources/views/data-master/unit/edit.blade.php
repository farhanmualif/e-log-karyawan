    ...
    <div class="mb-6">
        <div class="flex items-center justify-between gap-4 mb-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Edit data unit</p>
            </div>
            <a href="{{ route('unit.index') }}" class="flex items-center text-white px-3 py-2 hover:no-underline border rounded-lg bg-gray-600 hover:bg-gray-900">
        ...
        <form method="POST" action="{{ route('unit.update', $unit->id) }}">
            ...
            <div class="mb-6">
                ...
                <select id="departemen_id"
                    ...
                    <option value="{{ $dept->id }}" {{ old('departemen_id', $unit->departemen_id) == $dept->id ? 'selected' : '' }}>
                        {{ $dept->nama }}
                    </option>
                    @endforeach
                </select>
